...
(function () {
  ...
  const HUB = [
    ...
    { g: '聊天传讯', items: [
      ...
      { n: '邀请记录（我发出的邀请）', d: '聊天 → 更多功能 → 邀请TA 半框顶部「📜 邀请记录」：今天直接列出，更早的按日期折叠、点日期展开，一次露 5 天、点「加载更多」翻页', k: '邀请 记录 历史 邀请历史 邀请记录 查 哪里 找不到 折叠 分页 问问ta', go: ['.app[data-app="chat"]', '#more-invite'] },
