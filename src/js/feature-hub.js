...
(function () {
  ...
  const HUB = [
    ...
    { g: '互动与心意', items: [
      ...
      { n: '心意币 · 心意市集', d: '300+ 件商品分 13 类（含药品医护：常备药与外伤处理），送礼给 TA；也能许愿让 TA 挑一件送你；TA 自己许的愿有概率发到聊天，点【送 TA】一键买下送 TA（桌面有独立图标）', k: '市集 商店 礼物 购买 心意币 心愿单 许愿 TA送我 联系人送我礼物 TA心愿 心愿发到聊天 送TA 概率 药品 医护 感冒药 创可贴 碘伏 纱布 退烧药 胃药 受伤', go: ['.app[data-app="market"]'] },
